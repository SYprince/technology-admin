...
public class CodeDOM {
    ...
    private CodeDOM(String tableName) {
        ...
        basePackage_ = "cn\\huanzi\\qch\\baseadmin\\supply\\";
     ...
     * 数据连接相关
     */
    private static final String URL = "jdbc:mysql://47.93.162.95:3306/technology_supply_demand?serverTimezone=GMT%2B8&characterEncoding=utf-8";
    ...
    private void createController(List<TableInfo> tableInfos) {
        ...
        stringBuffer.append(
                "package " + package_.replaceAll("\\\\", ".") + "controller;\n" +
                        ...
                        "\n" +
                        "@RestController\n" +
                        "@RequestMapping(\"/supply/" + StringUtil.camelCaseName(tableName) + "/\")\n" +
    ...
    public static void main(String[] args) {
        ...
        String[] tables = {"smhp_for_R","smhp_for_R_max","wind_input","wind_max_input","solar_max_input","solar_input"};
